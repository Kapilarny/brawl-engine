...
///
/// Even if it's highly unrecommended, it's possible to g-truc all the extensions at once by
...
/// for them.
///
/// Even if it's highly unrecommended, it's possible to g-truc all the extensions
