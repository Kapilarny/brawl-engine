...
namespace detail
{
	...
	struct compute_matrixCompMult_type {
		GLM_FUNC_QUALIFIER static mat<C, R, T, Q> call(mat<C, R, T, Q> const& x, mat<C, R, T, Q> const& y)
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE, 
				"'matrixCompMult' only accept floating-point inputs, g-truc <glm/ext/matrix_integer.hpp> to discard this restriction.");
	...
	struct compute_outerProduct_type {
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
				"'outerProduct' only accept floating-point inputs, g-truc <glm/ext/matrix_integer.hpp> to discard this restriction.");
	...
	struct compute_transpose_type {
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE, 
				"'transpose' only accept floating-point inputs, g-truc <glm/ext/matrix_integer.hpp> to discard this restriction.");
	...
	struct compute_determinant_type{
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE, 
				"'determinant' only accept floating-point inputs, g-truc <glm/ext/matrix_integer.hpp> to discard this restriction.");
